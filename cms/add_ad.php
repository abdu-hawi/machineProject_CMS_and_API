...
<h2>Add ADVERTISING</h2>
<hr><br/>
<form id="uploadimagead" class="form-horizontal col-lg-10  col-md-12 col-sm-12 col-xs-12" action="" method="post" enctype="multipart/form-data">
	<div id="message">
    </div>
    ...
    <div class="form-group">        
      <div class="col-lg-12">
      	<input type="submit" value="Add Advertising" class="submit btn btn-success " />
      </div>
    </div>
...
$(document).ready(function (e) {
	$('#image_preview').hide();
	$("#uploadimagead").on('submit',(function(e) {
		e.preventDefault();
		$('#image_preview').show();
		$.ajax({
			url: "includeOP/add_ad_op.php", // Url to which the request is send
