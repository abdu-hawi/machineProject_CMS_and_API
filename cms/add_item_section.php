...
<form id="uploadimagesection" class="form-horizontal col-lg-10  col-md-12 col-sm-12 col-xs-12" action="" method="post" enctype="multipart/form-data">
    ...
    <div id="selectImage" class="form-group">
        <div class="panel-body">
			<input class="form-control" type="text" placeholder="Section name" id="sectionName" name="sectionName"  required />
    ...
    <div class="form-group">        
      <div class="col-lg-12">
      	<input type="submit" value="Add Section" class="submit btn btn-success " />
      </div>
    </div>
...
$(document).ready(function (e) {
	...
	$("#uploadimagesection").on('submit',(function(e) {
		...
		$('#image_preview').show();
		$.ajax({
			url: "includeOP/add_section_op.php", // Url to which the request is send
